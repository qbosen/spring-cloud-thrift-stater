...
public class ThriftServer {
    ...
    public static ThriftServer createServer(
            ...
            @Nullable ThriftServerConsulDiscoveryFactory discoveryFactory,
        ...
        return new ThriftServer(server, properties, serviceWrappers,
                discoveryFactory == null ? null : discoveryFactory.createConsulDiscovery(properties));
    }
    ...
    public void start(String threadName) {
        ...
        if (consulDiscovery != null) consulDiscovery.registerService();
    ...
    public void stop() {
        ...
        server.stop();
        if (consulDiscovery != null) consulDiscovery.unregisterService();
